 ...
 * @since 1.0
 */
public class ReversoWS implements IConsumerWS {
    private static Logger LOGGER = Logger.getLogger(ReversoWS.class.getName());
    ...
    public Object consume(String url, Object request, Class cls) throws NegocioException {
        ...
        // Consumir el servicio de REVERSO
        return port.compraReversar(compraProcesarSolicitud);
    }
}
