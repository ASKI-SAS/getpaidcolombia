 ...
 * 
 */
@WebServiceClient(name = "CompraElectronica_HTTP_Service", targetNamespace = "http://www.rbm.com.co/esb/comercio/compra/", wsdlLocation = "/WSDL/CompraElectronica/CompraElectronicaService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:"+new File("").getAbsolutePath()+"/WSDL/compraElectronica/CompraElectronicaService.wsdl");
